...
function exp_pontos_maravilha_0rule0_eval_expression(context) {
    // nome = 'CASA  FREI GALVÃO'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Name')  == 'casa_frei_galvao');
    } else {
        return (feature.get('Name')  == 'casa_frei_galvao');
    }
}
...
function exp_pontos_maravilha_0rule1_eval_expression(context) {
    // nome = 'ESCOLA DE ESPECIALISTAS DE AERONÁUTICA'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Name')  == 'eear');
    } else {
        return (feature.get('Name')  == 'eear');
    }
}
...
function exp_pontos_maravilha_0rule2_eval_expression(context) {
    // nome = 'ESTAÇÃO FERROVIÁRIA'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Name')  == 'estacao_ferroviaria');
    } else {
        return (feature.get('Name')  == 'estacao_ferroviaria');
    }
}
...
function exp_pontos_maravilha_0rule3_eval_expression(context) {
    // nome = 'BAIRRO DO GOMERAL'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Name')  == 'gomeral');
    } else {
        return (feature.get('Name')  == 'gomeral');
    }
}
...
function exp_pontos_maravilha_0rule4_eval_expression(context) {
    // nome = 'CATEDRAL SANTO ANTÔNIO'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Name')  == 'igreja_santo_antonio');
    } else {
        return (feature.get('Name')  == 'igreja_santo_antonio');
    }
}
...
function exp_pontos_maravilha_0rule5_eval_expression(context) {
    // nome = 'CAVALARIA'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Name')  == 'cavalaria');
    } else {
        return (feature.get('Name')  == 'cavalaria');
    }
}
...
function exp_pontos_maravilha_0rule6_eval_expression(context) {
    // nome = 'GRUTA DE NOSSA SENHORA DE LOURDES'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Name')  == 'gruta');
    } else {
        return (feature.get('Name')  == 'gruta');
    }
}